...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        Media cd = new CompactDisc(1, "The Beatles", "Music", 10.99f, 120, "me", "The Beatles");
        ...
        Media cd2 = new CompactDisc(4, "Thriller", "Music", 9.99f, 110,"Quincy Jones", "Michael Jackson");
        ...
        Media cd3 = new CompactDisc(8, "Kind of Blue", "Jazz", 11.49f, 55, "Miles Davis", "Miles Davis");
        ...
        Media cd4 = new CompactDisc(11, "The Four Seasons", "Classical", 14.49f, 80, "Antonio Vivaldi", "Vivaldi");
